...
def fetch_ci_time(filePath):
    entries = httpx.get("https://api.github.com/repos/zhonghaibin/weekly/commits?path=" + filePath + "&page=1&per_page=1")
...
if __name__ == "__main__":
  ...
  for index, name in enumerate(filenames):
      if name.endswith('.md'):
        ...
        url   = 'https://www.neijuan.fun/posts/' + oldTitle
